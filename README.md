...
added `attrsAsValues` option for personal usage. Even that is not original, it's
just a stale not-accepted-not-rejected PR to the original code which was needed
for a project: https://github.com/bruderstein/node-xml2js.

Original README bellow._
